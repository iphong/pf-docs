...
* [Events API](reference/events-api/README.md)
  * [Core API](reference/events-api/core-api.md)
  * [EventSource API](reference/events-api/eventsource-api.md)
  * [WebSocket API](reference/events-api/websocket-api.md)
* [Global State Hook](guides/global-state-hook.md)
* [Web Components](guides/web-components/README.md)
  * [Lit Element](guides/web-components/lit-element/README.md)
    * [Lit Element Docs](https://lit.dev/docs)
    * [Lit Element Playground](https://lit.dev/playground/)
  * [PageFly examples](guides/web-components/pagefly-examples.md)
