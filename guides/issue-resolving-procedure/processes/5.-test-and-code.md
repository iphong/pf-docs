...
{% hint style="info" %}
[Test-driven development (TDD)](https://en.wikipedia.org/wiki/Test-driven\_development) is a methodology in software development that encourages simple designs and inspires confidence.
{% endhint %}
