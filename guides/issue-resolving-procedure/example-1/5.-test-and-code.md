...
When everything is ready, let's create a test file for the test case "_there is no survey in the database, the server endpoint for getting survey data must return an empty array_".
